<template>
  <div class="video-wrapper" v-loading="loading">
    ...
    <div id="remote_stream" class="remote-stream"></div>
    ...
    <div class="btn-wrapper">
      <div class="btn-list-wrapper">
        ...
        <div class="btn-item">
          ...
          <img v-else :src="btnIcon.shareOff" @click="createScreenShare1" alt="">
...
export default {
  ...
  methods: {
    ...
    createScreenShare1 () {
      ...
      this.shareClient = TRTC.createClient({ mode: 'videoCall', sdkAppId, userId: this.shareId, userSig })
      ...
      this.shareClient.join({roomId: this.roomId}).then(() => {
        ...
        this.screeStream.initialize().then(() => {
          ...
          this.shareClient.publish(this.screeStream).then(() => {
            console.log('screen casting')
          })
        })
      })
