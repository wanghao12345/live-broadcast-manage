    ...
    <div class="btn-wrapper">
      <div class="btn-list-wrapper">
        ...
        <div class="btn-item">
          ...
          <span>{{shareStatus ? '停止共享' : '共享屏幕'}}</span>
        </div>
        <div class="btn-item">
  ...
  export default {
    ...
    methods: {
      ...
      createScreenShare () {
        ...
        let streamId = 'share_' + this.streamId

        this.shareClientStreamId = streamId
      ...
      publishStream (localStream, client, type = 1) {
        client
          ...
          .then(() => {
            ...
            } else if (this.client && !this.shareClient) {
              setTimeout(() => {
                this.postCloudMix1(this.clientStreamId)
              }, 5000)
            } else if (this.shareClient && !this.client) {
              setTimeout(() => {
                this.postCloudMix1(this.shareClientStreamId)
              }, 5000)
            }
      ...
      postCloudMix () {
        ...
        const data = {
          ...
          interface: {
            ...
            para: {
              ...
              mix_stream_session_id: 'lewis_room_' + this.streamId,
              ...
              input_stream_list: [
                ...
                {
                  input_stream_id: 'client_' + this.streamId,
                  layout_params: {
                    image_layer: 2,
                    image_width: 200,
                    image_height: 200
        ...
        postMix({
          ...
          // data.event_id && (this.mixEventId = data.event_id)
          console.log(res)
        })
      },
